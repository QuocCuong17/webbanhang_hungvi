    ...
    <body>
        ...
        <c:if test="${not empty sessionScope.username and sessionScope.role == 'admin'}">
            ...
            <form action="updateUser" method="post">
                Tên:  <input type="text" name="ten" value="${user.ten}">
                Email: <input type="text" name="email" value="${user.email}"><br>
                Địa chỉ: <input type="text" name="diachi" value="${user.diachi}"><br>
                Số điện thoại: <input type="text" name="sdt" value="${user.sdt}"><br>
                Role: <input type="text" name="role" value="${user.role}"><br>
                Balance: <input type="text" name="balance" value="${user.balance}"><br>
