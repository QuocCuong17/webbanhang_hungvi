        ...
        <main>
            <section>
                ...
                <form action="registerAdmin" method="post">
                    ...
                    <br>
                    <label for="msv">MÃ ADMIN</label>
                    <input type="text" id="madmin" name="madmin" required>
                    <br>
                ...
                <p><a href="loginAdmin.jsp" class="loginbtClick">Đã có tài khoản? Đăng nhập</a></p>
                <p class="error">
